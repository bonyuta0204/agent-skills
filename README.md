...
| [`review-design-doc`](skills/review-design-doc/SKILL.md) | GitHub PR 上の kpiee-designs 設計書を dedicated worktree で開き、文書品質と設計妥当性の 2 ステップでレビューして、日本語の inline review と総評を返す。 |
